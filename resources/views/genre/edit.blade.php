            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="/catalogue/update">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="genre_title" type="text" class="form-control" name="genre_title"
                                        value="{{ $genre->genre_title }}" value=""
                                        placeholder="Short title of the Genre" required autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <textarea rows="4" id="genre_description" type="text" class="form-control" name="genre_description"
                                         value="" placeholder="Longer description of the Genre" required>{{ $genre->genre_description }}</textarea>
